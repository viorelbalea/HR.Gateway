...
public sealed class AngajatGetOverviewResponse
{
    ...
    public required AngajatGetByEmailResponse Profil { get; init; }
    ...
    public IReadOnlyList<ConcediuYearDetailItem> PeAniDetaliat { get; init; } = Array.Empty<ConcediuYearDetailItem>();
}